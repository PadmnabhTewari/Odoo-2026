...
export function registerReportRoutes(app) {
    app.post('/api/reports/generate', requireAuth, requireRoles('ADMIN', 'ASSET_MANAGER', 'DEPARTMENT_HEAD'), (request, response) => {
        const { reportType = 'Utilization', reportRange = 'Last 30 days' } = request.body;
